...
<div class="container">
    <div class="nav-scroller py-1 mb-2" style="position: static;">
        <nav class="nav d-flex justify-content-between" style="position: static; display: block; left: auto; height: 30px;">
            ...
            <form method="GET" action="controller">
                <input class="p-2 text-muted" type="submit" value="<fmt:message key="admin.incident.list.headline"/>" style="outline: 0; border: 0; background: 0;">
                <input type="hidden" name="command" value="show_incident_list" />
            </form>
        </nav>
    </div>
</div>
